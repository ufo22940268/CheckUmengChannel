.class public Lcom/zhangdan/banka/utils/Base64Utils;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/zhangdan/banka/utils/Base64Utils$OutputStream;,
        Lcom/zhangdan/banka/utils/Base64Utils$InputStream;
    }
.end annotation
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/zhangdan/banka/utils/Base64Utils;->_STANDARD_ALPHABET:[B
    ...
    sput-object v0, Lcom/zhangdan/banka/utils/Base64Utils;->_STANDARD_DECODABET:[B
    ...
    sput-object v0, Lcom/zhangdan/banka/utils/Base64Utils;->_URL_SAFE_ALPHABET:[B
    ...
    sput-object v0, Lcom/zhangdan/banka/utils/Base64Utils;->_URL_SAFE_DECODABET:[B
    ...
    sput-object v0, Lcom/zhangdan/banka/utils/Base64Utils;->_ORDERED_ALPHABET:[B
    ...
    sput-object v0, Lcom/zhangdan/banka/utils/Base64Utils;->_ORDERED_DECODABET:[B
...
.method static synthetic access$000(I)[B
    ...
    .prologue
    .line 76
    invoke-static {p0}, Lcom/zhangdan/banka/utils/Base64Utils;->getAlphabet(I)[B
...
.method static synthetic access$100(I)[B
    ...
    .prologue
    .line 76
    invoke-static {p0}, Lcom/zhangdan/banka/utils/Base64Utils;->getDecodabet(I)[B
...
.method static synthetic access$200([BII[BII)[B
    ...
    .prologue
    .line 76
    invoke-static/range {p0 .. p5}, Lcom/zhangdan/banka/utils/Base64Utils;->encode3to4([BII[BII)[B
...
.method static synthetic access$300([BI[BII)I
    ...
    .prologue
    .line 76
    invoke-static {p0, p1, p2, p3, p4}, Lcom/zhangdan/banka/utils/Base64Utils;->decode4to3([BI[BII)I
...
.method static synthetic access$400([B[BII)[B
    ...
    .prologue
    .line 76
    invoke-static {p0, p1, p2, p3}, Lcom/zhangdan/banka/utils/Base64Utils;->encode3to4([B[BII)[B
...
.method public static decode(Ljava/lang/String;)[B
    ...
    invoke-static {p0, v0}, Lcom/zhangdan/banka/utils/Base64Utils;->decode(Ljava/lang/String;I)[B
...
.method public static decode(Ljava/lang/String;I)[B
    ...
    invoke-static {v5, v13, v11, p1}, Lcom/zhangdan/banka/utils/Base64Utils;->decode([BIII)[B
...
.method public static decode([BIII)[B
    ...
    .prologue
    .line 913
    invoke-static/range {p3 .. p3}, Lcom/zhangdan/banka/utils/Base64Utils;->getDecodabet(I)[B
    ...
    invoke-static {v2, v12, v8, v9, v0}, Lcom/zhangdan/banka/utils/Base64Utils;->decode4to3([BI[BII)I
...
.method private static decode4to3([BI[BII)I
    ...
    .line 833
    invoke-static {p4}, Lcom/zhangdan/banka/utils/Base64Utils;->getDecodabet(I)[B
...
.method public static decodeFileToFile(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .prologue
    .line 1300
    invoke-static {p0}, Lcom/zhangdan/banka/utils/Base64Utils;->decodeFromFile(Ljava/lang/String;)[B
...
.method public static decodeFromFile(Ljava/lang/String;)[B
    ...
    .line 1170
    .local v0, bis:Lcom/zhangdan/banka/utils/Base64Utils$InputStream;
    :try_start_0
    ...
    .line 1202
    :try_start_1
    invoke-virtual {v0}, Lcom/zhangdan/banka/utils/Base64Utils$InputStream;->close()V
    :try_end_1
    ...
    .line 1185
    new-instance v1, Lcom/zhangdan/banka/utils/Base64Utils$InputStream;
    ...
    invoke-direct {v1, v8, v9}, Lcom/zhangdan/banka/utils/Base64Utils$InputStream;-><init>(Ljava/io/InputStream;I)V
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_0
    .catch Ljava/io/IOException; {:try_start_2 .. :try_end_2} :catch_1

    .line 1189
    .end local v0           #bis:Lcom/zhangdan/banka/utils/Base64Utils$InputStream;
    .local v1, bis:Lcom/zhangdan/banka/utils/Base64Utils$InputStream;
    :goto_1
    const/16 v8, 0x1000

    :try_start_3
    invoke-virtual {v1, v2, v6, v8}, Lcom/zhangdan/banka/utils/Base64Utils$InputStream;->read([BII)I
    ...
    .line 1202
    :try_start_4
    invoke-virtual {v1}, Lcom/zhangdan/banka/utils/Base64Utils$InputStream;->close()V
    :try_end_4
    .catch Ljava/lang/Exception; {:try_start_4 .. :try_end_4} :catch_0

    move-object v0, v1

    .end local v1           #bis:Lcom/zhangdan/banka/utils/Base64Utils$InputStream;
    .end local v2           #buffer:[B
    .end local v5           #file:Ljava/io/File;
    .end local v6           #length:I
    .end local v7           #numBytes:I
    .restart local v0       #bis:Lcom/zhangdan/banka/utils/Base64Utils$InputStream;
    :goto_2
    move-object v8, v3
    ...
    .line 1203
    .end local v0           #bis:Lcom/zhangdan/banka/utils/Base64Utils$InputStream;
    .restart local v1       #bis:Lcom/zhangdan/banka/utils/Base64Utils$InputStream;
    .restart local v2       #buffer:[B
    .restart local v5       #file:Ljava/io/File;
    .restart local v6       #length:I
    .restart local v7       #numBytes:I
...
.method public static decodeToFile(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    .line 1138
    .local v0, bos:Lcom/zhangdan/banka/utils/Base64Utils$OutputStream;
    :try_start_0
    new-instance v1, Lcom/zhangdan/banka/utils/Base64Utils$OutputStream;
    ...
    invoke-direct {v1, v4, v5}, Lcom/zhangdan/banka/utils/Base64Utils$OutputStream;-><init>(Ljava/io/OutputStream;I)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_1

    .line 1140
    .end local v0           #bos:Lcom/zhangdan/banka/utils/Base64Utils$OutputStream;
    .local v1, bos:Lcom/zhangdan/banka/utils/Base64Utils$OutputStream;
    :try_start_1
    ...
    invoke-virtual {v1, v4}, Lcom/zhangdan/banka/utils/Base64Utils$OutputStream;->write([B)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_1
    .catch Ljava/io/IOException; {:try_start_1 .. :try_end_1} :catch_4
    ...
    .line 1148
    :try_start_2
    invoke-virtual {v1}, Lcom/zhangdan/banka/utils/Base64Utils$OutputStream;->close()V
    :try_end_2
    .catch Ljava/lang/Exception; {:try_start_2 .. :try_end_2} :catch_0
    ...
    .line 1153
    .end local v1           #bos:Lcom/zhangdan/banka/utils/Base64Utils$OutputStream;
    .restart local v0       #bos:Lcom/zhangdan/banka/utils/Base64Utils$OutputStream;
    :goto_0
    return v3

    .line 1149
    .end local v0           #bos:Lcom/zhangdan/banka/utils/Base64Utils$OutputStream;
    .restart local v1       #bos:Lcom/zhangdan/banka/utils/Base64Utils$OutputStream;
    :catch_0
    move-exception v4
    ...
    .line 1148
    :try_start_3
    invoke-virtual {v0}, Lcom/zhangdan/banka/utils/Base64Utils$OutputStream;->close()V
    :try_end_3
...
.method public static decodeToObject(Ljava/lang/String;)Ljava/lang/Object;
    ...
    .prologue
    .line 1055
    invoke-static {p0}, Lcom/zhangdan/banka/utils/Base64Utils;->decode(Ljava/lang/String;)[B
...
.method private static encode3to4([BII[BII)[B
    ...
    .line 476
    invoke-static {p5}, Lcom/zhangdan/banka/utils/Base64Utils;->getAlphabet(I)[B
...
.method private static encode3to4([B[BII)[B
    ...
    invoke-static/range {v0 .. v5}, Lcom/zhangdan/banka/utils/Base64Utils;->encode3to4([BII[BII)[B
...
.method public static encodeBytes([B)Ljava/lang/String;
    ...
    invoke-static {p0, v1, v0, v1}, Lcom/zhangdan/banka/utils/Base64Utils;->encodeBytes([BIII)Ljava/lang/String;
...
.method public static encodeBytes([BI)Ljava/lang/String;
    ...
    invoke-static {p0, v0, v1, p1}, Lcom/zhangdan/banka/utils/Base64Utils;->encodeBytes([BIII)Ljava/lang/String;
...
.method public static encodeBytes([BII)Ljava/lang/String;
    ...
    invoke-static {p0, p1, p2, v0}, Lcom/zhangdan/banka/utils/Base64Utils;->encodeBytes([BIII)Ljava/lang/String;
...
.method public static encodeBytes([BIII)Ljava/lang/String;
    ...
    .line 722
    .local v10, b64os:Lcom/zhangdan/banka/utils/Base64Utils$OutputStream;
    :try_start_0
    ...
    :try_start_1
    new-instance v11, Lcom/zhangdan/banka/utils/Base64Utils$OutputStream;

    or-int/lit8 v4, p3, 0x1

    invoke-direct {v11, v13, v4}, Lcom/zhangdan/banka/utils/Base64Utils$OutputStream;-><init>(Ljava/io/OutputStream;I)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_1
    .catch Ljava/io/IOException; {:try_start_1 .. :try_end_1} :catch_c

    .line 724
    .end local v10           #b64os:Lcom/zhangdan/banka/utils/Base64Utils$OutputStream;
    .local v11, b64os:Lcom/zhangdan/banka/utils/Base64Utils$OutputStream;
    :try_start_2
    ...
    :goto_0
    :try_start_5
    invoke-virtual {v11}, Lcom/zhangdan/banka/utils/Base64Utils$OutputStream;->close()V
    :try_end_5
    .catch Ljava/lang/Exception; {:try_start_5 .. :try_end_5} :catch_5
    ...
    .line 792
    .end local v11           #b64os:Lcom/zhangdan/banka/utils/Base64Utils$OutputStream;
    ...
    .line 729
    .restart local v10       #b64os:Lcom/zhangdan/banka/utils/Base64Utils$OutputStream;
    ...
    :goto_5
    :try_start_a
    invoke-virtual {v10}, Lcom/zhangdan/banka/utils/Base64Utils$OutputStream;->close()V
    :try_end_a
    ...
    .end local v12           #baos:Ljava/io/ByteArrayOutputStream;
    .end local v18           #gzos:Ljava/util/zip/GZIPOutputStream;
    .restart local v11       #b64os:Lcom/zhangdan/banka/utils/Base64Utils$OutputStream;
    ...
    invoke-static/range {v4 .. v9}, Lcom/zhangdan/banka/utils/Base64Utils;->encode3to4([BII[BII)[B
...
.method public static encodeFileToFile(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .prologue
    .line 1272
    invoke-static {p0}, Lcom/zhangdan/banka/utils/Base64Utils;->encodeFromFile(Ljava/lang/String;)Ljava/lang/String;
...
.method public static encodeFromFile(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {v1, v9, v10}, Lcom/zhangdan/banka/utils/Base64Utils$InputStream;-><init>(Ljava/io/InputStream;I)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_1
    ...
    :try_start_1
    invoke-virtual {v1, v2, v7, v9}, Lcom/zhangdan/banka/utils/Base64Utils$InputStream;->read([BII)I
...
.method public static encodeObject(Ljava/io/Serializable;)Ljava/lang/String;
    ...
    invoke-static {p0, v0}, Lcom/zhangdan/banka/utils/Base64Utils;->encodeObject(Ljava/io/Serializable;I)Ljava/lang/String;
...
.method public static encodeObject(Ljava/io/Serializable;I)Ljava/lang/String;
    ...
    invoke-direct {v1, v3, v11}, Lcom/zhangdan/banka/utils/Base64Utils$OutputStream;-><init>(Ljava/io/OutputStream;I)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_1
...
.method public static encodeToFile([BLjava/lang/String;)Z
    ...
    .local v1, bos:Lcom/zhangdan/banka/utils/Base64Utils$OutputStream;
    :try_start_1
    invoke-virtual {v1, p0}, Lcom/zhangdan/banka/utils/Base64Utils$OutputStream;->write([B)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_1
    .catch Ljava/io/IOException; {:try_start_1 .. :try_end_1} :catch_4
...
.method private static final getAlphabet(I)[B
    ...
    .line 355
    sget-object v0, Lcom/zhangdan/banka/utils/Base64Utils;->_URL_SAFE_ALPHABET:[B
    ...
    .line 357
    sget-object v0, Lcom/zhangdan/banka/utils/Base64Utils;->_ORDERED_ALPHABET:[B

    goto :goto_0

    .line 359
    :cond_1
    sget-object v0, Lcom/zhangdan/banka/utils/Base64Utils;->_STANDARD_ALPHABET:[B
...
.method private static final getDecodabet(I)[B
    ...
    .line 371
    sget-object v0, Lcom/zhangdan/banka/utils/Base64Utils;->_URL_SAFE_DECODABET:[B
    ...
    .line 373
    sget-object v0, Lcom/zhangdan/banka/utils/Base64Utils;->_ORDERED_DECODABET:[B

    goto :goto_0

    .line 375
    :cond_1
    sget-object v0, Lcom/zhangdan/banka/utils/Base64Utils;->_STANDARD_DECODABET:[B
...
.method public static final main([Ljava/lang/String;)V
    ...
    invoke-static {v3}, Lcom/zhangdan/banka/utils/Base64Utils;->usage(Ljava/lang/String;)V
    ...
    .line 397
    invoke-static {v1, v2}, Lcom/zhangdan/banka/utils/Base64Utils;->encodeFileToFile(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 400
    invoke-static {v1, v2}, Lcom/zhangdan/banka/utils/Base64Utils;->decodeFileToFile(Ljava/lang/String;Ljava/lang/String;)V
