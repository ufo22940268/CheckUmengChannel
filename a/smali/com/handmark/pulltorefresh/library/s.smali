...
.method public constructor <init>(Lcom/handmark/pulltorefresh/library/PullToRefreshHorizontalScrollView;Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object p1, p0, Lcom/handmark/pulltorefresh/library/s;->a:Lcom/handmark/pulltorefresh/library/PullToRefreshHorizontalScrollView;
...
.method protected final overScrollBy(IIIIIIIIZ)Z
    ...
    iget-object v0, p0, Lcom/handmark/pulltorefresh/library/s;->a:Lcom/handmark/pulltorefresh/library/PullToRefreshHorizontalScrollView;

    const/4 v5, 0x0

    invoke-virtual {p0}, Lcom/handmark/pulltorefresh/library/s;->getChildCount()I
    ...
    invoke-virtual {p0, v1}, Lcom/handmark/pulltorefresh/library/s;->getChildAt(I)Landroid/view/View;
    ...
    invoke-virtual {p0}, Lcom/handmark/pulltorefresh/library/s;->getWidth()I

    move-result v3

    invoke-virtual {p0}, Lcom/handmark/pulltorefresh/library/s;->getPaddingLeft()I

    move-result v4

    sub-int/2addr v3, v4

    invoke-virtual {p0}, Lcom/handmark/pulltorefresh/library/s;->getPaddingRight()I
